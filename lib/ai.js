...
export async function getDailyCoachAdvice(profile, caloriesConsumed, weights = []) {
    try {
        ...
        1. Fornisci un consiglio motivazionale molto breve ma potente (max 15-20 parole). 
           IMPORTANTE: Se disponi dello storico peso, commenta l'andamento (es. "Grande progresso con i -X kg!" o "Stiamo tenendo botto, non mollare il peso!") o incoraggia a pesarsi se i dati sono vecchi o assenti.
